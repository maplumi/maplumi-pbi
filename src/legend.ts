...
export class LegendManager {
    ...
    //     choroplethItemsContainer.style.flexDirection = "column";
    ...
    //     title.style.fontWeight = "bold";
    //     title.style.marginBottom = "5px";
    //     choroplethItemsContainer.appendChild(title);
    ...
    //     this.choroplethLegendContainer.appendChild(itemsContainer);
